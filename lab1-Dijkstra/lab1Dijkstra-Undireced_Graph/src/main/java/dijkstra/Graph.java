...
public class Graph {
	...
	public void addEdge(Edge edge) {
		...
		Edge reverseEdge = new Edge(nodeEndEdge, nodeStartEdge, edge.getWeight()); // Create reverse edges
		adjacencyList.get(nodeEndEdge).add(reverseEdge); // Adding reverse edges for undirected graph
	}
	...
	public void addEdge(Node startNode, Node endNode, int weight) {
		...
		adjacencyList.get(endNode).add(new Edge(endNode, startNode, weight)); // Adding reverse edges for undirected graph
	}
	...
	public void addEdge(String startNode, String endNode, int weight) {
		...
		adjacencyList.get(endNode).add(new Edge(nodeEndEdge, nodeStartEdge, weight)); // Adding reverse edges for undirected graph
	}
